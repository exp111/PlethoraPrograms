...
--KEYS:
local launchUpKey = keys.e
local launchDirectionKey = keys.f
local mobScanKey = keys.numPad9
local useSpamKey = keys.numPad8
local aimbotKey = keys.numPad7
local noFallKey = keys.numPad6
local hoverKey = keys.numPad5
local oreScanKey = keys.numPad4
